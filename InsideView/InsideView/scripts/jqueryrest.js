...
(function ($) {
    ...
    var R = $.rest = {
        ...
        prep: function () {
            ...
            if (o.proxyUrl) o.url = o.proxyUrl + encodeURIComponent(o.url);
        ...
        processOut: function (o) {
            ...
            if (o.data.requestBody) { // added since we don't need the wrapper,if "requestBody" key is used then only value is appended to request body
                if (typeof o.data.requestBody != "string")
                    o.data = JSON.stringify(o.data.requestBody || {});
                else
                    o.data = o.data.requestBody;
            }
            else {
